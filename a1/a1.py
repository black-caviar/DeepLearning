...
plt.xlim([0,1])
#plt.show()
plt.savefig('initial_basis.png', format='png', dpi=300)
plt.clf()
...
#plt.show()
plt.savefig('before_opt.png', format='png', dpi=300)
plt.clf()
...
#plt.ylim([-1,1])
#plt.show()
plt.savefig('after_opt.png', format='png', dpi=300)
plt.clf()
...
plt.xlabel('x'); plt.ylabel('y', rotation=0); plt.xlim([0,1])
#plt.show()
plt.savefig('final_basis.png', format='png')
